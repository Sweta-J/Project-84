...
function add() {
	...
	img_imgTag.src = image;   // load image
}
...
function my_keydown(e) {
	...
	if ((keyPressed >=97 && keyPressed<=122) || (keyPressed >=65 && keyPressed<=90)) {
		...
		otherkey();
		document.getElementById("d1").innerHTML = "You pressed a symbol";
		console.log("Other key");
	}
}

function alphabetkey() {
	image = "Alphabet_key.png";
	add();
}

function numberkey() {
	image = "Number_key.png";
	add();
}
